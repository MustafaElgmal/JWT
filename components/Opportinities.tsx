            ...
            <div className="pt-10 md:pt-20">
                <div className="container mx-auto">
                    <div className="flex flex-wrap items-center pb-12">
                        <h1 className="text-xl lg:text-4xl  font-black">Senior Community Manager (French + Arabic)</h1>
                        <div className="md:w-1/2 lg:w-2/3 w-full xl:pr-20 md:pr-6">
                            <div className="py-2 text-color">
                                <h2 className="text-lg lg:text-3xl  py-4 md:py-8">
                                    We are looking for an Senior Community Manager with 3+ years of experience.
                        ...
                        <div className="lg:w-1/3 md:w-1/2 w-full relative h-96 flex items-end justify-center">
                            <img className="absolute w-full h-full inset-0  object-center" src="https://lxwnzovjjfyhbnrqtzqh.supabase.co/storage/v1/object/public/jwt/hiring/306572586_4839193886182233_6677423841384758624_n.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="mx-auto">
                    <div className="flex flex-wrap flex-row-reverse items-center">
                        ...
                        <div className="md:w-1/2 lg:w-2/3 w-full lg:pl-20 md:pl-10 sm:pl-0 pl-0">
                            <div className="py-2 text-color">
                                <h2 className="text-lg lg:text-3xl  py-4 md:py-8">
                                    We are looking for an Senior Social & Data Analyst with 3+ years of experience.
                                    If you got the moves, show us!
                                </h2>
                                <div className="flex items-center cursor-pointer pb-4 md:pb-0">
                                    <h3 className=" text-lg lg:text-2xl font-semibold underline text-indigo-700">Come join us!</h3>
                        ...
                        <div className="lg:w-1/3 md:w-1/2 w-full relative h-96 flex items-end justify-center">
                            <img className="absolute w-full h-full inset-0  object-center " src="https://lxwnzovjjfyhbnrqtzqh.supabase.co/storage/v1/object/public/jwt/hiring/306610981_4839193889515566_4155762857593362245_n.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
