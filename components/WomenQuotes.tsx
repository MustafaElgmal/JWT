    ...
    return (
        <>
                ...
                <div className="w-full bg-pink-200 px-10 py-10">
                    <div className="container mx-auto">
                        <div className="lg:flex md:flex sm:flex items-center xl:justify-between flex-wrap md:justify-around sm:justify-around lg:justify-around">
                            {women.map((woman) => (
                                <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative  lg:mb-2  my-24  sm:mb-24 xl:max-w-sm lg:w-2/5">
            ...
            <div className='text-center bg-gray-500  py-2 lg:w-80 w-48 mx-auto  mt-10'>
                <Link href="/Women">
                    <a className='lg:text-xl p-2 text-sm text-center text-gray-100 font-bold text-decoration-none hover:text-white'>See Our Wounder Women</a>
                </Link>
            </div>
        </>
    );
